...
const DOMAIN_FIELDS = {
  language: {
    ...
    waiting: '{name_ga} 답답해서 보채거나 울 때, 바로 들어주고 싶을 수 있습니다. 그럴 때는 잠깐 기다리며 더 나은 표현이 나오는지 보세요. 보채서 바로 얻으면 그 방법이 굳어집니다.',
    reinforcement: '단어나 몸짓으로 표현하면 → 그 자리에서 바로 들어주세요.\n\n카드를 짚거나 가리키면 → "이거 말했구나" 하고 바로 반응해 주세요.\n\n칭찬보다, 표현한 것을 바로 들어주는 게 더 정확한 보상입니다.',
  ...
  selfcare: {
    ...
    waiting: '{name_ga} 굼뜨거나 멈춰 있을 때, 답답해서 대신 해주고 싶을 수 있습니다. 그럴 때는 속으로 다섯을 세며 기다려 주세요. 스스로 해볼 시간을 주는 게 중요합니다.',
    reinforcement: '마지막 동작을 스스로 해내면 → "혼자 했네" 하고 바로 알아봐 주세요.\n\n시도만 해도 → "해보려고 했구나" 하고 격려해 주세요.\n\n결과보다 스스로 해보려는 시도를 봐주세요.',
  ...
  social: {
    ...
    waiting: '{name_ga} 눈을 안 맞추거나 딴 데를 봐도, 억지로 돌리지 마세요. 그럴 때는 잠깐 기다리며 스스로 쳐다보는 순간을 노려보세요. 자발적으로 본 그 순간이 가장 좋은 기회입니다.',
    reinforcement: '눈이 마주치면 → 바로 웃어주고 물건을 건네주세요.\n\n손을 내밀거나 다가오면 → "같이 하자" 하고 바로 받아주세요.\n\n주고받음이 일어난 직후, 바로 반응해 주는 게 핵심입니다.',
  ...
  cognition: {
    ...
    waiting: '{name_ga} 바로 답을 못 찾아도, 정답을 먼저 말해주지 마세요. 그럴 때는 잠깐 기다리며 스스로 고를 시간을 주세요. 기다리는 그 몇 초가 배우는 시간입니다.',
    reinforcement: '맞히면 → "맞았어" 하고 바로 작은 보상을 주세요.\n\n스스로 고르려 하면 → "잘 보고 있네" 하고 격려해 주세요.\n\n맞힌 직후 바로 반응해야 무엇을 잘했는지 압니다.',
  ...
  behavior: {
    ...
    waiting: '{name_ga} 행동을 보일 때 바로 반응하고 싶을 수 있습니다. 그럴 때는 잠깐 멈추고, 대체 행동이 나올 틈을 주세요. 문제 행동에 매번 빠르게 반응하면 그 행동이 더 굳어집니다.',
    reinforcement: '대체 행동을 택하면 → 그 자리에서 바로 들어주세요.\n\n"그만"을 표현으로 알리면 → 바로 멈춰 주세요. 표현이 통한다는 걸 알려주는 겁니다.\n\n문제 행동보다 대체 행동이 더 빠르게 통하게 해주세요.',
    weekly_focus: '{name_ga} 대체 행동을 택한 횟수',
  },
};
...
const TOPIC_TEMPLATES = [
  {
    ...
    fields: {
      ...
      goal: '{name_ga} 양치 과정에서 한 단계라도 스스로 해내는 것을 봅니다. 칫솔을 입에 가져가기, 위아래로 한 번 닦기처럼 작은 동작 하나면 충분합니다. 하루 한 번이라도 나오면 성공입니다.',
      materials: '아이용 칫솔과 평소 쓰던 치약(양은 쌀알만큼만).\n\n거울, 그리고 양치 순서를 보여줄 간단한 그림(선택).',
      practice: '1단계 (1분) - 거울 앞에서 어머님이 먼저 닦는 모습을 보여주세요. {name_ga} 보고만 있어도 괜찮습니다.\n\n2단계 (2분) - 어머님이 손을 받쳐 함께 닦다가, 맨 마지막 한 번은 {name}가 스스로 움직이게 두세요.\n\n3단계 (2분) - 한 부분이라도 스스로 닦으면 바로 멈추고 끝내 주세요. 짧고 성공적으로 끝나는 경험이 중요합니다.',
      waiting: '{name_ga} 입을 안 벌리거나 칫솔을 밀어내도, 억지로 밀어넣지 마세요. 그럴 때는 잠깐 멈추고 스스로 다시 시도할 틈을 주세요. 강하게 밀어붙이면 양치 자체가 더 싫어집니다.',
      reinforcement: '칫솔을 입에 가져가면 → "혼자 가져갔네" 하고 바로 알아봐 주세요.\n\n한 번이라도 닦으면 → 바로 칭찬하고 양치를 끝내 주세요.\n\n다 끝낸 뒤 좋아하는 활동으로 이어주면 양치에 대한 거부감이 줄어듭니다.',
      weekly_focus: '{name_ga} 양치에서 스스로 한 동작을 해낸 횟수',
      next_priority: '이번 주에 마지막 한 동작이 익숙해지면, 다음 주는 그 앞 동작까지 스스로 해보게 넓혀가세요. 거부가 여전히 크다면, 닦는 시간보다 칫솔에 익숙해지는 것부터 다시 시작하는 게 좋습니다.',
    },
  },
  {
    id: 'shoes',
    ...
    fields: {
      ...
      goal: '{name_ga} 신발 신기에서 마지막 한 동작이라도 스스로 하는 것을 봅니다. 발뒤꿈치 당기기, 찍찍이 붙이기 하나면 충분합니다. 5번 중 2~3번 나오면 성공입니다.',
      materials: '신고 벗기 쉬운 신발(찍찍이 형태가 좋습니다).\n\n앉아서 신을 수 있는 낮은 의자나 계단.',
      practice: '1단계 (1분) - 어머님이 발을 거의 다 넣어주시고, 마지막 당기기나 찍찍이 붙이기만 남겨두세요.\n\n2단계 (2분) - 그 마지막 동작을 {name_ga} 스스로 하게 두세요. 손을 살짝 받쳐주셔도 됩니다.\n\n3단계 (2분) - 익숙해지면 그 앞 동작(발 넣기)도 조금씩 맡겨보세요.',
      waiting: '{name_ga} 잘 안 되어 짜증 내도, 바로 대신 해주지 마세요. 그럴 때는 잠깐 기다리며 다시 해볼 틈을 주세요. 스스로 해낸 경험이 다음 시도를 만듭니다.',
      reinforcement: '마지막 동작을 해내면 → "혼자 신었네" 하고 바로 알아봐 주세요.\n\n신고 나면 → 바로 좋아하는 곳으로 나가거나 활동으로 이어주세요.\n\n신발을 신으면 좋은 일이 생긴다는 연결이 중요합니다.',
      weekly_focus: '{name_ga} 신발 신기에서 스스로 한 동작을 해낸 횟수',
      next_priority: '마지막 동작이 익숙해지면 다음 주는 앞 동작까지 넓혀가세요. 양쪽 신발을 다 신는 건 시간이 걸리니, 한 짝부터 천천히 가도 됩니다.',
    },
  },
  {
    id: 'dressing',
    ...
    fields: {
      ...
      goal: '{name_ga} 옷 입기에서 한 단계라도 스스로 하는 것을 봅니다. 팔 끼우기, 머리 통과시키기, 바지 올리기 하나면 충분합니다. 하루 한 번이라도 나오면 성공입니다.',
      materials: '입고 벗기 편한 헐렁한 옷(목·소매가 넓은 것).\n\n앉아서 입을 수 있는 공간.',
      practice: '1단계 (1분) - 어머님이 옷을 거의 입혀주시고, 마지막 한 동작(바지 끝까지 올리기 등)만 남겨두세요.\n\n2단계 (2분) - 그 동작을 {name_ga} 스스로 하게 두세요. 처음엔 손을 받쳐주셔도 됩니다.\n\n3단계 (2분) - 익숙해지면 그 앞 단계도 하나씩 맡겨보세요. 한 번에 하나씩만 늘립니다.',
      waiting: '{name_ga} 팔이 안 들어가 답답해해도, 바로 해주지 마세요. 그럴 때는 잠깐 기다리며 스스로 맞춰볼 시간을 주세요. 몇 초의 기다림이 배우는 시간입니다.',
      reinforcement: '한 단계라도 스스로 하면 → "혼자 입었네" 하고 바로 알아봐 주세요.\n\n시도만 해도 → "해보려고 했구나" 하고 격려해 주세요.\n\n다 입은 뒤 거울을 보여주며 함께 기뻐해 주셔도 좋습니다.',
      weekly_focus: '{name_ga} 옷 입기에서 스스로 한 단계를 해낸 횟수',
      next_priority: '한 단계가 익숙해지면 다음 주는 그 앞 단계까지 넓혀가세요. 단추나 지퍼는 손 힘이 더 필요하니, 큰 단추부터 천천히 시작하는 게 좋습니다.',
    },
  },
  {
    id: 'handwash',
    ...
    fields: {
      ...
      goal: '{name_ga} 손 씻기에서 한 단계라도 스스로 하는 것을 봅니다. 비누 문지르기, 헹구기 하나면 충분합니다. 하루 한 번이라도 나오면 성공입니다.',
      materials: '아이가 닿기 쉬운 받침대(세면대가 높으면).\n\n거품이 잘 나는 비누, 손 씻는 순서 그림(선택).',
      practice: '1단계 (1분) - 어머님이 대부분을 함께 해주시고, 마지막 헹구기만 {name}에게 남겨주세요.\n\n2단계 (2분) - 그 동작을 {name_ga} 스스로 하게 두세요. 손을 받쳐주셔도 됩니다.\n\n3단계 (2분) - 익숙해지면 비누 문지르기 같은 앞 단계도 맡겨보세요.',
      waiting: '{name_ga} 대충 하고 끝내려 해도, 다그치지 마세요. 그럴 때는 잠깐 기다리며 한 번 더 해볼 틈을 주세요. 완벽함보다 스스로 하는 경험이 먼저입니다.',
      reinforcement: '한 단계라도 스스로 하면 → "깨끗하게 했네" 하고 바로 알아봐 주세요.\n\n손을 다 씻으면 → 바로 다음 활동(간식 등)으로 이어주세요.\n\n손 씻기 뒤에 좋은 일이 오면 습관이 자리잡습니다.',
      weekly_focus: '{name_ga} 손 씻기에서 스스로 한 단계를 해낸 횟수',
      next_priority: '한 단계가 익숙해지면 다음 주는 앞 단계까지 넓혀가세요. 순서를 자주 빠뜨리면, 그림 순서표를 세면대 앞에 붙여두는 것도 도움이 됩니다.',
    },
  },
  {
    id: 'spoon',
    ...
    fields: {
      ...
      goal: '{name_ga} 숟가락이나 포크로 한 입이라도 스스로 떠먹는 것을 봅니다. 다 흘려도 입까지 가져가면 성공입니다. 한 끼에 한두 번이라도 나오면 충분합니다.',
      materials: '손에 쥐기 쉬운 짧고 굵은 손잡이의 숟가락·포크.\n\n잘 떠지는 음식(걸쭉한 죽, 잘 찍히는 과일 조각).',
      practice: '1단계 (1분) - 어머님이 음식을 떠서 숟가락을 쥐여주고, 입까지 가져가는 마지막만 {name}가 하게 두세요.\n\n2단계 (2분) - 익숙해지면 떠올리는 것도 손을 받쳐 함께 해보세요.\n\n3단계 (2분) - 한 입이라도 스스로 먹으면 충분히 알아봐 주세요. 흘리는 건 자연스러운 과정입니다.',
      waiting: '{name_ga} 흘리거나 손으로 먹으려 해도, 바로 뺏지 마세요. 그럴 때는 잠깐 기다리며 다시 숟가락을 쥐어보게 하세요. 흘리면서 배우는 게 정상입니다.',
      reinforcement: '한 입 스스로 떠먹으면 → "혼자 먹었네" 하고 바로 알아봐 주세요.\n\n도구를 쥐기만 해도 → "잘 잡았네" 하고 격려해 주세요.\n\n좋아하는 음식으로 연습하면 시도가 더 자주 나옵니다.',
      weekly_focus: '{name_ga} 숟가락·포크로 스스로 떠먹은 횟수',
      next_priority: '한 입이 익숙해지면 다음 주는 흘리는 양을 줄이는 쪽으로 가세요. 도구가 손에 안 맞아 자꾸 놓치면, 손잡이가 더 굵은 것으로 바꿔보는 것도 방법입니다.',
    },
  },
  {
    id: 'toilet',
    ...
    fields: {
      ...
      goal: '{name_ga} 정해진 시간에 변기에 앉아보는 것을 봅니다. 성공 여부보다 거부 없이 앉는 경험이 먼저입니다. 하루 한두 번 앉아보면 충분합니다.',
      materials: '아이 발이 닿는 유아 변기나 발 받침대.\n\n앉아 있는 동안 볼 좋아하는 책이나 장난감.',
      practice: '1단계 (1분) - 식사 후처럼 배변하기 쉬운 시간에 변기로 데려가세요.\n\n2단계 (2분) - 옷을 입은 채라도 변기에 잠깐 앉아보게 하세요. 좋아하는 것을 쥐여주면 편하게 앉습니다.\n\n3단계 (2분) - 거부 없이 앉으면 그것만으로 충분히 칭찬하고 내려와도 됩니다.',
      waiting: '{name_ga} 변기를 무서워하거나 바로 일어나려 해도, 억지로 앉히지 마세요. 그럴 때는 짧게 앉는 것부터 시작하세요. 변기가 안전한 곳이라는 느낌이 먼저입니다.',
      reinforcement: '변기에 앉으면 → "잘 앉았네" 하고 바로 칭찬해 주세요.\n\n성공하면 → 크게 기뻐하며 좋아하는 보상을 주세요.\n\n실수해도 혼내지 마세요. 다음 시도를 위축시킬 수 있습니다.',
      weekly_focus: '{name_ga} 거부 없이 변기에 앉은 횟수',
      next_priority: '앉는 게 편해지면 다음 주는 신호가 올 때 데려가는 연습으로 넘어가세요. 아이마다 준비되는 속도가 다르니, 조급해하지 않으셔도 됩니다.',
    },
  },
  {
    id: 'request',
    ...
    fields: {
      ...
      goal: '{name_ga} 원하는 것을 말·단어·카드·몸짓 중 하나로 요청하는 것을 봅니다. 5번 중 2~3번 자발적으로 나오면 충분합니다. 발음이 정확하지 않아도 시도 자체를 봐주세요.',
      materials: '{name}가 지금 가장 원하는 물건이나 간식 하나.\n\n요청을 도울 그림카드나 사진(선택).',
      practice: '1단계 (1분) - 원하는 물건을 보이는 곳에, 손이 바로 닿지는 않는 곳에 두세요.\n\n2단계 (2분) - {name_ga} 그것을 보면, 요청 방법(이름 말하기·카드 짚기·가리키기)을 손을 받쳐 도와주세요.\n\n3단계 (2분) - 요청이 나오면 그 자리에서 바로 들어주세요. 요청하면 얻는다는 걸 빠르게 연결해 줍니다.',
      waiting: '{name_ga} 울거나 보채면 바로 주고 싶을 수 있습니다. 그럴 때는 잠깐 기다리며 더 나은 요청이 나오는지 보세요. 보채서 얻는 경험이 쌓이면 그 방법이 굳어집니다.',
      reinforcement: '이름을 말하거나 카드를 짚으면 → 그 자리에서 바로 물건을 주세요.\n\n가리키기라도 하면 → "이거 줄까" 하고 바로 들어주세요.\n\n"잘했어"보다 원하는 걸 바로 주는 것이 더 정확한 보상입니다.',
      weekly_focus: '{name_ga} 적절한 방법으로 요청한 횟수',
      next_priority: '요청이 자리잡으면 다음 주는 한 단계 늘려보세요. 가리키기가 되면 단어로, 단어가 되면 짧은 문장으로. 한 번에 하나씩만 올립니다.',
    },
  },
  {
    id: 'respond_name',
    ...
    fields: {
      ...
      goal: '이름을 불렀을 때 {name_ga} 쳐다보거나 반응하는 것을 봅니다. 5번 중 2~3번 나오면 충분합니다. 잠깐 눈을 맞추는 것만으로도 성공입니다.',
      materials: '{name}가 좋아하는 물건이나 간식(쳐다볼 동기).\n\n조용하고 자극이 적은 공간.',
      practice: '1단계 (1분) - 가까이에서 {name} 이름을 부르고, 동시에 좋아하는 것을 눈높이에 들어 보여주세요.\n\n2단계 (2분) - 쳐다보면 바로 그것을 주거나 함께 웃어주세요. 부름과 좋은 일을 연결합니다.\n\n3단계 (2분) - 익숙해지면 조금 떨어진 곳에서, 물건 없이 이름만 불러보세요.',
      waiting: '이름을 불러도 반응이 없을 때, 여러 번 연달아 부르지 마세요. 한 번 부르고 잠깐 기다리세요. 계속 부르면 이름이 그냥 배경 소리가 되어버립니다.',
      reinforcement: '쳐다보면 → 바로 웃어주고 좋아하는 것을 주세요.\n\n고개만 돌려도 → "여기 봤네" 하고 바로 반응해 주세요.\n\n반응한 직후 바로 좋은 일이 오면 다음에 더 잘 쳐다봅니다.',
      weekly_focus: '{name_ga} 이름을 불렀을 때 쳐다보거나 반응한 횟수',
      next_priority: '이름에 반응이 잘 나오면 다음 주는 물건 없이도, 더 먼 거리에서도 되는지 넓혀가세요. 반응이 드물면, 부르는 횟수를 줄이고 한 번을 더 즐겁게 만드는 게 좋습니다.',
    },
  },
  {
    id: 'imitate_word',
    ...
    fields: {
      ...
      goal: '{name_ga} 어머님이 낸 소리나 짧은 단어를 따라 해보는 것을 봅니다. 정확하지 않아도, 비슷하게 내려는 시도면 충분합니다. 5번 중 1~2번이라도 나오면 성공입니다.',
      materials: '소리를 붙이기 좋은 장난감(자동차 "부릉", 동물 "멍멍").\n\n마주 보고 입 모양을 볼 수 있는 거리.',
      practice: '1단계 (1분) - {name}가 좋아하는 놀이를 하며 짧은 소리를 자주 들려주세요("부릉~", "꿀꺽").\n\n2단계 (2분) - 입 모양을 크게 보여주며 한 소리를 내고, {name_ga} 따라 할 틈을 주세요.\n\n3단계 (2분) - 비슷한 소리라도 내면 바로 그 놀이를 더 신나게 이어주세요.',
      waiting: '따라 하지 않아도 다그치지 마세요. 한 소리를 들려주고 잠깐 기다리며 입을 보게 하세요. 조용히 기다리는 그 순간에 아이가 소리를 준비합니다.',
      reinforcement: '비슷한 소리라도 내면 → 바로 크게 반응하며 놀이를 이어주세요.\n\n입만 움직여도 → "말하려고 했네" 하고 격려해 주세요.\n\n소리를 내면 재미있는 일이 생긴다는 연결이 핵심입니다.',
      weekly_focus: '{name_ga} 소리나 단어를 따라 하려고 시도한 횟수',
      next_priority: '한 소리가 나오면 다음 주는 소리 수를 늘리거나 짧은 단어로 넓혀가세요. 아직 소리가 안 나오면, 따라 하기보다 먼저 소리를 즐겁게 많이 들려주는 단계로 돌아가도 됩니다.',
    },
  },
  {
    id: 'eyecontact',
    ...
    fields: {
      ...
      goal: '{name_ga} 짧게라도 눈을 맞추는 것을 봅니다. 1초라도 마주치면 성공입니다. 5번 중 2~3번 나오면 충분합니다. 길게 보길 기대하지 않으셔도 됩니다.',
      materials: '{name}가 좋아하는 물건이나 간식(눈높이로 들 것).\n\n마주 앉을 수 있는 조용한 공간.',
      practice: '1단계 (1분) - {name}와 마주 앉아, 좋아하는 것을 어머님 눈 옆 높이로 들어 보여주세요.\n\n2단계 (2분) - {name_ga} 그것을 보다가 어머님 눈과 마주치는 순간, 바로 그것을 주거나 웃어주세요.\n\n3단계 (2분) - 익숙해지면 물건을 점점 치우고, 이름을 부르며 눈이 마주치길 기다려보세요.',
      waiting: '{name_ga} 눈을 안 맞추거나 딴 데를 봐도, 억지로 고개를 돌리지 마세요. 그럴 때는 잠깐 기다리며 스스로 보는 순간을 노려보세요. 자발적으로 본 그 순간이 가장 좋은 기회입니다.',
      reinforcement: '눈이 마주치면 → 바로 환하게 웃어주고 좋아하는 것을 주세요.\n\n살짝이라도 보면 → "봤네" 하고 바로 반응해 주세요.\n\n마주친 직후 바로 좋은 일이 오면, 다음에 더 자주 쳐다봅니다.',
      weekly_focus: '{name_ga} 눈을 맞춘 횟수',
      next_priority: '눈맞춤이 잦아지면 다음 주는 물건 없이도, 대화 중에도 자연스럽게 마주치는지 넓혀가세요. 눈맞춤이 드물면, 억지로 늘리기보다 즐거운 놀이 속에서 자연스럽게 나오게 하는 게 좋습니다.',
    },
  },
  {
    id: 'turntaking',
    ...
    fields: {
      ...
      goal: '{name_ga} 한 번이라도 차례를 기다렸다가 자기 순서에 참여하는 것을 봅니다. 짧게라도 기다리면 성공입니다. 놀이당 1~2번이라도 나오면 충분합니다.',
      materials: '둘이 번갈아 할 수 있는 놀이(공 굴리기, 블록 쌓기, 자동차 밀기).\n\n순서를 보여줄 짧은 말("엄마 차례", "OO 차례").',
      practice: '1단계 (1분) - "엄마 차례" 하고 어머님이 먼저 한 번 하고, "OO 차례" 하며 {name}에게 넘기세요.\n\n2단계 (2분) - 이 주고받기를 짧고 빠르게 반복해, 기다리는 시간이 길지 않게 하세요.\n\n3단계 (2분) - {name_ga} 기다렸다가 자기 차례에 참여하면, 그 순간을 신나게 반응해 주세요.',
      waiting: '{name_ga} 자기 차례를 못 기다리고 뺏으려 해도, 혼내지 마세요. 그럴 때는 차례를 아주 짧게 만들어 기다림을 줄여주세요. 성공 경험이 쌓이면 기다리는 시간을 늘릴 수 있습니다.',
      reinforcement: '차례를 기다리면 → "잘 기다렸네" 하고 바로 자기 순서를 주세요.\n\n자기 차례에 참여하면 → 함께 신나게 반응해 주세요.\n\n기다림 다음에 바로 즐거운 자기 차례가 오면, 기다리는 게 가치 있어집니다.',
      weekly_focus: '{name_ga} 차례를 기다렸다가 참여한 횟수',
      next_priority: '짧은 차례가 익숙해지면 다음 주는 기다리는 시간을 조금씩 늘리거나, 세 명이서 하는 차례로 넓혀가세요. 기다리기 어려우면 차례를 더 짧게 되돌려도 됩니다.',
    },
  },
  {
    id: 'play_together',
    ...
    fields: {
      ...
      goal: '{name_ga} 짧게라도 어머님과 같은 놀이에 함께 참여하는 것을 봅니다. 잠깐이라도 같이 하면 성공입니다. 하루 한두 번이라도 나오면 충분합니다.',
      materials: '둘이 함께 해야 재밌는 놀이(공 주고받기, 비눗방울, 함께 쌓기).\n\n방해가 적은 조용한 공간.',
      practice: '1단계 (1분) - {name_ga} 하는 놀이에 어머님이 슬쩍 끼어, 옆에서 같은 걸 해보세요.\n\n2단계 (2분) - 비눗방울처럼 혼자서는 안 되고 둘이라야 재밌는 놀이로 자연스럽게 끌어들이세요.\n\n3단계 (2분) - 잠깐이라도 함께하면, 그 놀이를 더 신나고 길게 이어주세요.',
      waiting: '{name_ga} 혼자 놀려고 하거나 끼어드는 걸 밀어내도, 억지로 끼어들지 마세요. 그럴 때는 옆에서 기다리며 함께할 틈이 생기길 노려보세요. 아이가 먼저 받아주는 순간이 가장 좋습니다.',
      reinforcement: '함께 참여하면 → 그 놀이를 더 재밌게 만들어 주세요.\n\n잠깐 같이 봐주거나 주고받으면 → "같이 하니까 재밌네" 하고 반응해 주세요.\n\n함께할 때 더 즐겁다는 경험이 쌓이면 같이 노는 시간이 늘어납니다.',
      weekly_focus: '{name_ga} 함께 놀이에 참여한 횟수',
      next_priority: '둘이 노는 게 익숙해지면 다음 주는 또래 한 명과 짧게 해보는 쪽으로 넓혀가세요. 아직 어려우면, 어머님과 함께하는 시간을 더 쌓는 것이 먼저입니다.',
    },
  },
  {
    id: 'screaming',
    ...
    fields: {
      ...
      goal: '소리 지르기 대신 {name_ga} 다른 방법(카드 짚기, "그만" 표현, 어머님 끌기)을 한 번이라도 택하는 것을 봅니다. 하루 1~2번이라도 나오면 충분합니다. 없애기보다 바꿔주기입니다.',
      materials: '소리 지르기 직전의 신호(상황·표정)를 적을 메모.\n\n대신할 표현을 도울 도구("그만"·"도와줘" 카드).',
      practice: '1단계 (1분) - 소리 지르기 직전에 무슨 일이 있었는지 살펴보세요. 그 신호가 보이는 순간이 개입 시점입니다.\n\n2단계 (2분) - 소리가 커지기 전에, 미리 정한 표현(카드 짚기 등)을 하도록 도와주세요.\n\n3단계 (2분) - 그 표현이 나오면 바로 들어주세요. 소리보다 표현이 더 빠르게 통한다는 걸 경험하게 합니다.',
      waiting: '소리를 지를 때 바로 달래주거나 원하는 걸 주고 싶을 수 있습니다. 그럴 때는 잠깐 멈추고, 차분해지거나 다른 표현이 나올 틈을 주세요. 소리 지를 때마다 바로 반응하면 그 방법이 굳어집니다.',
      reinforcement: '카드나 표현으로 알리면 → 그 자리에서 바로 들어주세요.\n\n소리 대신 다른 행동을 택하면 → "이렇게 말하니 알겠네" 하고 바로 반응해 주세요.\n\n소리 지를 때보다 표현할 때 더 빠르게 통하게 해주세요.',
      weekly_focus: '{name_ga} 소리 지르기 대신 다른 표현을 택한 횟수',
      next_priority: '대체 표현이 자리잡으면 다음 주는 그 표현을 더 다양한 상황에서 쓰게 넓혀가세요. 소리 지르기가 특정 상황에만 몰린다면, 그 상황 자체를 조정하는 것도 함께 살펴보세요.',
    },
  },
  {
    id: 'tantrum',
    ...
    fields: {
      ...
      goal: '떼쓰기 대신 {name_ga} 다른 방법(말·카드·기다리기)을 한 번이라도 택하는 것을 봅니다. 하루 1~2번이라도 나오면 충분합니다. 떼의 크기가 조금 줄어드는 것도 성공입니다.',
      materials: '떼쓰기가 자주 나오는 상황을 적을 메모(언제·무엇 때문에).\n\n대신할 표현을 도울 도구(요청 카드, 기다림 신호).',
      practice: '1단계 (1분) - 떼가 시작되기 직전의 상황을 살펴보세요. 무엇이 막혔을 때 나오는지 패턴을 봅니다.\n\n2단계 (2분) - 떼가 커지기 전에, 원하는 걸 표현하는 방법(카드·말)을 도와주세요.\n\n3단계 (2분) - 표현이 나오면 가능한 범위에서 바로 들어주세요. 떼쓰기보다 표현이 통한다는 걸 경험하게 합니다.',
      waiting: '떼를 쓸 때 빨리 그치게 하려고 바로 원하는 걸 주고 싶을 수 있습니다. 그럴 때는 위험하지 않다면 잠깐 차분해질 시간을 주세요. 떼쓸 때마다 들어주면 그 방법이 더 강해집니다.',
      reinforcement: '말이나 카드로 표현하면 → 가능한 범위에서 바로 들어주세요.\n\n차분해지면 → "진정했네" 하고 바로 알아봐 주세요.\n\n떼쓸 때보다 차분히 표현할 때 더 잘 통하게 해주세요.',
      weekly_focus: '{name_ga} 떼쓰기 대신 다른 표현을 택한 횟수',
      next_priority: '대체 표현이 늘면 다음 주는 떼가 자주 나오던 상황을 미리 대비하는 쪽으로 가세요. 떼쓰기가 줄지 않으면, 어떤 상황에서 가장 심한지 기록을 모아 함께 살펴봅시다.',
    },
  },
  {
    id: 'aggression',
    ...
    fields: {
      ...
      goal: '던지기·때리기 대신 {name_ga} 안전한 방법(카드·말·다른 행동)을 한 번이라도 택하는 것을 봅니다. 하루 1~2번이라도 나오면 충분합니다. 강도가 줄어드는 것도 성공입니다.',
      materials: '그 행동이 나오기 직전의 신호를 적을 메모.\n\n대신할 안전한 행동을 도울 도구("그만" 카드, 누르거나 쥘 수 있는 물건).',
      practice: '1단계 (1분) - 던지거나 때리기 직전의 신호(표정·몸짓)를 살펴보세요. 그 순간이 개입 시점입니다.\n\n2단계 (2분) - 행동이 터지기 전에, 미리 정한 안전한 행동(카드 짚기, 쿠션 누르기)으로 유도해 주세요.\n\n3단계 (2분) - 안전한 행동이 나오면 바로 들어주거나 반응해 주세요.',
      waiting: '때리거나 던질 때 크게 반응하고 싶을 수 있습니다. 그럴 때는 우선 안전을 확보하고, 과한 반응은 줄이세요. 큰 반응 자체가 그 행동을 더 끌어낼 수 있습니다.',
      reinforcement: '안전한 행동을 택하면 → 그 자리에서 바로 들어주거나 반응해 주세요.\n\n신호 단계에서 멈추면 → "참았네" 하고 바로 알아봐 주세요.\n\n공격 행동보다 안전한 표현이 더 빠르게 통하게 해주세요.',
      weekly_focus: '{name_ga} 던지기·때리기 대신 안전한 행동을 택한 횟수',
      next_priority: '대체 행동이 자리잡으면 다음 주는 그 행동이 자주 나오던 상황을 미리 대비하세요. 위험이 클 때는 행동 줄이기보다 안전 확보가 늘 먼저이며, 빈번하면 센터와 함께 더 자세히 살펴보는 게 좋습니다.',
    },
  },
];
